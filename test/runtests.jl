...
@testset "Yoda.jl" begin
    ...
    mc_hists = Yoda.get_all_histograms("./output.yoda")
    lep_hists = Yoda.get_all_scatter("./ALEPH_1996_S3486095.yoda")
    
    #data_hist = Yoda.get_all_scatter_to_names("test/ALEPH_1996_S3486095.yoda",mc_hists[:,1])
    data_hist = Yoda.get_all_scatter_to_names("./ALEPH_1996_S3486095.yoda",test_observable)
